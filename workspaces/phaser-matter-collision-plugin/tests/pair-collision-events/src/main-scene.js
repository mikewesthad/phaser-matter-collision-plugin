/**
 * Verify that the matterCollision.events "paircollisionstart", "paircollisionend",
 * "paircollisionactive" are all firing for a bouncing ball hitting the ground, bouncing and then
 * coming to rest.
 */
