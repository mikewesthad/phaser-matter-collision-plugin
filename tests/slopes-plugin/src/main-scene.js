/**
 * NOTE AN AUTOMATED TEST YET. This isn't exactly trimmed down, but this a platformer and tests it
 * against the phaser slopes plugin.
 */
...
export default class MainScene extends Phaser.Scene {
  ...
  onPlayerCollideStart({ gameObjectB }) {
